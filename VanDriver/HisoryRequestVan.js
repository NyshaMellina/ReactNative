      ...
      renderItem = (item) => {
          return(
              <View style = {styles.mainView}>
                ...
                <Text style={styles.anotherFont}>145963</Text>
                <Text style={styles.anotherFont1}>Samrat</Text>
                <Text style={styles.anotherFont2}>65823</Text>
                <Text style={styles.anotherFont3}>12/4/12</Text>
