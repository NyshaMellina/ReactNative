        ...
        return(
          <View style={styles.container}>
            ...
            <View style={styles.userView}>
              ...
              <Image source={require('../Components/Navigation/icon/user_id.png')} style = {styles.imageiconView}/>
              <Image source={require('../Components/Navigation/icon/role.png')} style = {{marginTop:33,marginLeft:8,marginRight:5}}/>
              <Image source={require('../Components/Navigation/icon/name.png')} style = {{marginTop:33,marginLeft:8,marginRight:5}}/>
              </View>
