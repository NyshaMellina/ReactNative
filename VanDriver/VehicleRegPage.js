...
import startRide from './startRideMap'
...
type Props = {};
// export default class VehicleRegpage extends Component<Props> {
//     render(){
//       return(
//           <App />
//       );
    ...
    return(
        ...
        <View style={styles.container}>
          <View style = {styles.backgroundContainer}>
            <Image source={require('../images/back2.jpeg')} style = {styles.background}/>
            </View>
            <View style={styles.vehicleView}>
            <Image source={require('../images/van.png')} style = {{height:60,width:70}}/>
            <Text style={styles.textContent}>VEHICLE REGISTRATION</Text>
            ...
            <TextInput style={styles.textView} placeholder="Vehicle Registration Number" placeholderTextColor="white"></TextInput>
            ...
            <TouchableOpacity style={styles.ButtonView} onPress={() => this.props.navigation.push('startRideMap')}>
            <Text style={styles.textView1}>START RIDE</Text>
            </TouchableOpacity>
